...
define gui.accent_color = '#3f5191'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#5876ca'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#444154'
...
define gui.text_font = "fonts/determination.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/determination.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/determination.ttf"
